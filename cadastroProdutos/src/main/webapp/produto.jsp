...
<body>
	...
	<div id="container" class="container">
		...
		<form name="formulario" id="idform" method="post"
			action="${url}">
			<fieldset>
				...
				<c:if test="${op eq 'C'}">
					<div class="form-row">
						<div class="form-group col-md-4">
							<label>Código do Produto:</label> <input class="form-control"
								type="text" id="codigo" name="codigo" value="${prod.codigo}"
								readonly />
						</div>
					</div>
				</c:if>
					...
					<div class="form-group col-md-4">
						...
						<div class="form-check">
							<div class="form-check-inline">
								<input class="form-check-input" type="radio" name="lojafisica"
									id="opsim" value="S"
				...
				<div class="form-row">
					<div class="form-group col-md-4">
						<label>Quantidade:</label> <input class="form-control"
							type="number" placeholder="99999" min="0" id="quantidade"
							name="quantidade" value="${prod.quantidade}" />
					</div>
					<div class="form-group col-md-4">
						<label>Preço:</label> <input class="form-control" type="text"
							pattern="[0-9]+([,][0-9]{2})?" placeholder="99999,99" min="0"
							step="any" id="preco" name="preco"
							value="${prod != null ? String.format('%.2f',prod.preco).replace('.',',') : ''}" />
					</div>
					<div class="form-group col-md-4">
						<label>Data de Validade:</label> <input class="form-control"
							type="date" class="data" id="datavalidade" name="datavalidade"
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						...
						<textarea class="form-control" id="descricao" name="descricao"
							rows="5" placeholder="<Descreva detalhes do produto aqui>">${prod.descricao}</textarea>
					</div>
				</div>
